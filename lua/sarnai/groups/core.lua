...
function M.get(palette)
	return {
		...
		Conceal                                  = { bg = "NONE" },
		CurSearch                                = { fg = palette.base, bg = palette.els },
		...
		MatchParen                               = { fg = palette.nuur, bg = palette.nuur, blend = 25 },
		...
		Visual                                   = { bg = palette.uvs, blend = 15 },
		-- VisualNOS = {},
		WarningMsg                               = { fg = palette.els, bold = styles.bold },
		-- Whitespace = {},
