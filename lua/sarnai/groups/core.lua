...
function M.get(palette)
	return {
		...
		markdownH1                               = { fg = palette.sarnai, bold = styles.bold },
		markdownH1Delimiter                      = { link = "markdownH1" },
		markdownH2                               = { fg = palette.mus, bold = styles.bold },
		markdownH2Delimiter                      = { link = "markdownH2" },
		markdownH3                               = { fg = palette.els, bold = styles.bold },
		markdownH3Delimiter                      = { link = "markdownH3" },
		markdownH4                               = { fg = palette.nuur, bold = styles.bold },
		markdownH4Delimiter                      = { link = "markdownH4" },
		markdownH5                               = { fg = palette.uvs, bold = styles.bold },
