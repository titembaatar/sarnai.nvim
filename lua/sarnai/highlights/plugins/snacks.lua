...
function M.get(palette, opts)
  ...
  return {
    ...
    SnacksNotifierBorderDebug = { fg = util.blend(p.syntax.comment, p.ui.bg, 0.4), bg = opts.transparent and p.none or p.ui.bg },
    ...
    SnacksNotifierBorderError = { fg = p.semantic.error_bg, bg = opts.transparent and p.none or p.ui.bg },
    ...
    SnacksNotifierBorderInfo  = { fg = p.semantic.info_bg, bg = opts.transparent and p.none or p.ui.bg },
    ...
    SnacksNotifierBorderTrace = { fg = p.semantic.ok_bg, bg = opts.transparent and p.none or p.ui.bg },
    ...
    SnacksNotifierBorderWarn  = { fg = p.semantic.warn_bg, bg = opts.transparent and p.none or p.ui.bg },
